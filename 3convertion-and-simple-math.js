...
var numberToString = String(numberData);
var stringToNumber = Number(stringData);
var booleanToString = String(booleanData);
var stringToBoolean = Boolean(stringData);

//float , integer , tofixed , rounded , ceil , abs 
var num = 4.502554
